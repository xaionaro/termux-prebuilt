...
/* VOID:VOID (../src/gdk-pixbuf/gdk-pixbuf-marshal.list:25) */
#define _gdk_pixbuf_marshal_VOID__VOID	g_cclosure_marshal_VOID__VOID

/* VOID:INT,INT (../src/gdk-pixbuf/gdk-pixbuf-marshal.list:26) */
extern
...
/* VOID:INT,INT,INT,INT (../src/gdk-pixbuf/gdk-pixbuf-marshal.list:27) */
extern
...
/* VOID:POINTER (../src/gdk-pixbuf/gdk-pixbuf-marshal.list:28) */
